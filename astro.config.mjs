...
// Dominio principale: tale.ws (altri domini: tales.ws, tale.mobi, tales.mobi)
const siteUrl = forceCustomDomain ? 'https://tale.ws' : (useGitHubConfig ? 'https://keyserdsoze.github.io' : 'https://tale.ws');
